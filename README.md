# CSCI161-CH06-ASSIGNMENT
Problems from Data Structures and Algorithms in Java 6th Edition. Make sure your answer for each question is in the appropriate folder. This week you can put all of your answers into a .md file. If you feel it is appropriate, feel free to add folders with supporting code. There are NO autograder tests this week!
...
##Creativity
C-6.19 - Postfix notation is an unambiguous way of writing an arithmetic expression without parenthesis.  It is defined so that if "exp_1"**op**"exp_2" is a normal fully parenthesized expression whose expression is **op**, the postfix version of this is "pexp_1 pexp_2 **op**".  So for example, the postfix version of ((5+2)*(8-3))/4 is 5 2 + 8 3 - * 4 /.  Describe a non-recursive way of evaluating in expression in postfix notation.
